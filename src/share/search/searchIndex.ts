...
export const searchIndex: SearchItem[] = [
  ...
  },
  {
    ...
    path: "/placeholder-4",
    content: "Надежда, добрые люди, поддержка, благие дела, помощь ближним.",
  },
  {
    id: "your-time",
    title: "ТВОЁ ВРЕМЯ — ЧЬЯ-ТО НАДЕЖДА",
    path: "/placeholder-5",
    content: "Отзывчивые люди, волонтерство, поддержка, помощь, надежда.",
  },
  {
    id: "support-partner",
  ...
  },
  {
    ...
    content: "Волонтерские акции, участие, координация, помощь нуждающимся.",
  },
  {
    id: "support-tree",
    title: "Дерево в Раю",
  ...
  },
  {
    ...
    content: "История проекта, как все начиналось, поддержка нуждающихся.",
  },
];
  ...
  const scored = searchIndex
    .map((item) => {
      ...
      const titleBoost = tokens.reduce(
        (acc, t) => acc + (item.title.toLowerCase().includes(t) ? 1 : 0),
        0,
      );
