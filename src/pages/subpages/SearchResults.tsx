  ...
  return (
    <>
      ...
      <div className={styles.pageBlock}>
        <h2>Поиск</h2>
        <p style={{ marginTop: -4, color: metaColor }}>
          Запрос: {query ? `“${query}”` : "—"}
        </p>

        {query && results.length > 0 && (
          <p style={{ marginTop: 12, marginBottom: 20, color: metaColor }}>
        ...
        {!query && (
          <p style={{ color: metaColor }}>
            Введите запрос в поле поиска вверху.
          </p>
        )}

        {query && results.length === 0 && (
          <p style={{ marginTop: 12, color: metaColor }}>
