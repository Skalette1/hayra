...
import house from '../../../public/100x100bb.jpg'; // твоя иконка дома
  ...
  return (
    <>
      ...
      <aside className={styles.sidebar}>
        ...
        <div className={styles.numberText}>Карта</div>
      </aside>
      <div className={styles.mapWrapper}>
        <MapContainer center={[43.32, 45.69]} zoom={11} style={{ height: '500px', width: '100%' }}>
          <TileLayer
